...
app.get("/api/consulta_rango/:rangosFechas", (req, res) => {
  ...
  let sql3 ="SELECT fecha_solicitud,nom_cargo FROM vsolicitud WHERE nom_area ='Operativa' AND  fecha_vac_start BETWEEN '2023-02-14' AND '2023-03-03'";
  ...
  let sql5 ="SELECT fecha_solicitud,nom_cargo FROM vsolicitud WHERE nom_area ='Operativa' AND  fecha_vac_start BETWEEN '2023-01-11' AND '2023-01-27'";
  let sql6 ="SELECT fecha_solicitud,nom_cargo FROM vsolicitud WHERE nom_area ='Operativa' AND  fecha_vac_start BETWEEN '2023-01-11' AND '2023-01-27'";
  let sql7 ="SELECT fecha_solicitud,nom_cargo FROM vsolicitud WHERE nom_area ='Operativa' AND  fecha_vac_start BETWEEN '2023-01-11' AND '2023-01-27'";
  let sql8 ="SELECT fecha_solicitud,nom_cargo FROM vsolicitud WHERE nom_area ='Operativa' AND  fecha_vac_start BETWEEN '2023-01-11' AND '2023-01-27'";
  let sql9 ="SELECT fecha_solicitud,nom_cargo FROM vsolicitud WHERE nom_area ='Operativa' AND  fecha_vac_start BETWEEN '2023-01-11' AND '2023-01-27'";
  let sql10 ="SELECT fecha_solicitud,nom_cargo FROM vsolicitud WHERE nom_area ='Operativa' AND  fecha_vac_start BETWEEN '2023-01-11' AND '2023-01-27'";
  let sql11 ="SELECT fecha_solicitud,nom_cargo FROM vsolicitud WHERE nom_area ='Operativa' AND  fecha_vac_start BETWEEN '2023-01-11' AND '2023-01-27'";
  let sql12 ="SELECT fecha_solicitud,nom_cargo FROM vsolicitud WHERE nom_area ='Operativa' AND  fecha_vac_start BETWEEN '2023-01-11' AND '2023-01-27'";
  let sql13 ="SELECT fecha_solicitud,nom_cargo FROM vsolicitud WHERE nom_area ='Operativa' AND  fecha_vac_start BETWEEN '2023-01-11' AND '2023-01-27'";
  let sql14 ="SELECT fecha_solicitud,nom_cargo FROM vsolicitud WHERE nom_area ='Operativa' AND  fecha_vac_start BETWEEN '2023-01-11' AND '2023-01-27'";
  let sql15 ="SELECT fecha_solicitud,nom_cargo FROM vsolicitud WHERE nom_area ='Operativa' AND  fecha_vac_start BETWEEN '2023-01-11' AND '2023-01-27'";
  let sql16 ="SELECT fecha_solicitud,nom_cargo FROM vsolicitud WHERE nom_area ='Operativa' AND  fecha_vac_start BETWEEN '2023-01-11' AND '2023-01-27'";
  let sql17 ="SELECT fecha_solicitud,nom_cargo FROM vsolicitud WHERE nom_area ='Operativa' AND  fecha_vac_start BETWEEN '2023-01-11' AND '2023-01-27'";
  let sql18 ="SELECT fecha_solicitud,nom_cargo FROM vsolicitud WHERE nom_area ='Operativa' AND  fecha_vac_start BETWEEN '2023-01-11' AND '2023-01-27'";
  let sql19 ="SELECT fecha_solicitud,nom_cargo FROM vsolicitud WHERE nom_area ='Operativa' AND  fecha_vac_start BETWEEN '2023-01-11' AND '2023-01-27'";
  let sql20 ="SELECT fecha_solicitud,nom_cargo FROM vsolicitud WHERE nom_area ='Operativa' AND  fecha_vac_start BETWEEN '2023-01-11' AND '2023-01-27'";  
...
app.get("/api/solicitud/:id_empleado", (req, res) => {
  //Consulta a la base de datos usando la sentencia sql que viene por parámetro con el id de la solicitud
  conexion.query(
    "SELECT * FROM solicitud WHERE id_empleado = ?",
